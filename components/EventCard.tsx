...
import eventPlaceholder from "../assets/images/eventPlaceholder.png";
      ...
      <div className={styles.eventCardContainer}>
        <div className={styles.eventCard}>
          <div className={styles.eventCardImageContainer}>
            {event.image_src ? (
              <Image
                src={event.image_src} // replace with event.image
                alt="event image"
                objectFit="contain"
                objectPosition="top"
                placeholder="blur"
              ...
              <Image
                src={eventPlaceholder} // replace with event.image
                alt="event image"
                objectFit="contain"
                objectPosition="top"
                placeholder="blur"
          ...
          <div className={styles.eventCardInfoContainer}>
            <div className={styles.eventCardInfo}>
              <div className={styles.eventCardInfoHeaderContainer}>
                <h3>{event.title}</h3> {/* replace with event.title */}
